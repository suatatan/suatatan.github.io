...
| 25 | `https://suatatan.com/data/performance/sql%20server/2025/08/07/sql-approx-query.html` | UPDATE | Valuable SQL article, but a category containing a space created a malformed/non-normalized path. | Move canonical URL to `https://suatatan.com/data/performance/sql-server/2025/08/07/sql-approx-query.html`; retain a legacy redirect page at the space-containing route. |
...
- Twenty-three migrated 2024 posts had a second YAML block rendered as article text. The same migration also left Obsidian-style `[[slug]]` links unresolved.
